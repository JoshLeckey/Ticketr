<x-guest-layout>
   <center>   <x-jet-validation-errors class="mb-4" />
    </center>
        ...
        <div class="md:flex w-full">
                    ...
                    <div class="flex -mx-3">
                        <div class="w-full px-3 mb-5">
                            ...
                            <div class="flex">
                                ...
                                <x-jet-input id="name" class="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-blue-500" type="text" name="name" :value="old('name')" required autofocus autocomplete="name" />
                            </div>
                        </div>
                    </div>
                    <div class="flex -mx-3">
                        <div class="w-full px-3 mb-5">
                            ...
                            <div class="flex">
                               ...
                               <x-jet-input id="email" class="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-blue-500" type="email" name="email" :value="old('email')" required />
                            </div>
                        </div>
                    </div>
                    <div class="flex -mx-3">
                        <div class="w-full px-3 mb-5">
                            ...
                            <div class="flex">
                                ...
                                <x-jet-input id="password" class="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-blue-500" type="password" name="password" required autocomplete="new-password" />
                            </div>
                        </div>
                    </div>
                     <div class="flex -mx-3">
                        <div class="w-full px-3 mb-12">
                            ...
                            <div class="flex">
                                <div class="w-10 z-10 pl-1 text-center pointer-events-none flex items-center justify-center"><i class="mdi mdi-lock-outline text-gray-400 text-lg"></i></div>
                                <x-jet-input id="password_confirmation" class="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-blue-500" type="password" name="password_confirmation" required autocomplete="new-password" />
                            </div>
                        </div>
                    </div>
            ...
            @endif
                    <div class="flex -mx-3">
                       ...
                       <x-jet-button class="mx-auto bg-blue-500 hover:bg-blue-700 focus:bg-blue-700 text-white rounded-lg px-3 py-3 font-semibold text-center">
                    {{ __('Register') }}
                </x-jet-button>
                        <br><br>
