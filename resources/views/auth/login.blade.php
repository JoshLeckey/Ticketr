<x-guest-layout>
    ...
    <center>
        ...
        <div role="alert">
  <p><x-jet-validation-errors class="mb-4" /></p>
</div>
                    ...
                    <div class="flex -mx-3">
                        <div class="w-full px-3 mb-5">
                            ...
                            <div class="flex">
                                ...
                                <x-jet-input id="email" class="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-blue-500" type="email" name="email" :value="old('email')" required autofocus />
                            </div>
                        </div>
                    </div>
                    <div class="flex -mx-3">
                        <div class="w-full px-3 mb-5">
                            ...
                            <div class="flex">
                                ...
                                <x-jet-input id="password" class="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-blue-500" type="password" name="password" required autocomplete="current-password" />
                            </div>
                        </div>
                    </div>
                    <div class="flex -mx-3">
